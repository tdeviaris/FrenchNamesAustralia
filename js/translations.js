...
const translations = {
    ...
    'en': {
        ...
        'about-sitemap-content': "<h3>Overview</h3><p>The <em>French Names Along the Australian Coastline</em> website explores the legacy of French toponyms along Australia's coasts, originating from the d'Entrecasteaux (1791-1794) and Baudin (1800-1804) expeditions. It consists of five main sections accessible from the navigation menu.</p><h3>1. Home</h3><p>The homepage presents the historical context of the project through visual storytelling. An introductory video simulates the arrival of <em>Le Géographe</em> in Geographe Bay. The following sections explain:</p><ul><li>The project's objectives and the context of French explorations</li><li>The d'Entrecasteaux expedition (1791-1794) and its mission to search for Lapérouse</li><li>The Baudin expedition (1800-1804) and its nomenclature influenced by Napoleonic political upheavals</li><li>Different ways to explore the site: interactive map, AI assistant, and documentary resources</li></ul><h3>2. Interactive Map</h3><p>The <strong>interactive map</strong> allows you to visually explore the 670 French place names along Australian coasts. You can:</p><ul><li>Toggle between d'Entrecasteaux toponyms (68 names) and Baudin toponyms (602 names)</li><li>Click on each marker to discover detailed information</li><li>View the original French name, its current Australian equivalent, and when available, the Aboriginal name</li><li>Read the story behind each naming choice</li><li>Access original maps, illustrations, and period documents</li></ul><h3>3. AI Q&A (Intelligent Assistant)</h3><p>The <strong>AI assistant</strong> is a specialized conversational tool that answers your questions about:</p><ul><li>The d'Entrecasteaux and Baudin expeditions</li><li>The 670 French place names and their origins</li><li>The explorers, scientists, and figures commemorated</li><li>The historical, political, and scientific context of the voyages</li></ul><p>This assistant allows you to deepen your knowledge in an interactive and personalized manner.</p><p><strong>Please note:</strong> this assistant is not infallible. Don't hesitate to ask it to verify information if you have any doubts.</p><h3>4. Resources</h3><p>The <strong>Resources</strong> section brings together all the project's documentation:</p><ul><li><strong>Podcast</strong>: audio presentation of the voyages, their routes, and nomenclature</li><li><strong>Glossary of Terms</strong>: explanations of historical, political, and scientific concepts (French institutions, political regimes, wars, etc.)</li><li><strong>Key Figures</strong>: biographical notes on explorers, scientists, and personalities from both expeditions</li><li><strong>Maps and Illustrations</strong>: historical atlases, original maps, sketches, and documents from the expeditions</li><li><strong>Sources</strong>: complete list of manuscript archives, digital libraries, and museum collections consulted</li></ul><h3>5. About</h3><p>The <strong>About</strong> section presents:</p><ul><li>The two French expeditions with detailed audio presentations</li><li>The project author, Dany Bréelle, historian specializing in French expeditions to Australia</li><li>Project supporters and partners</li><li>Educational resources and applications</li><li>The site structure (this page)</li><li>Legal notices</li></ul>",
