...
const translations = {
    'fr': {
        ...
        'dentre-title': "Carte Interactive : L'Expédition d'Entrecasteaux (1791-1793)", 'dentre-desc': "Explorez les noms de lieux donnés lors de l'expédition d'Antoine Bruny d'Entrecasteaux, qui a cartographié en grand détail les côtes de la Tasmanie à la recherche de La Pérouse. Cliquez sur un marqueur pour découvrir plus d'informations.",
        'dentre-text-p1': "Le premier objectif de l'expédition d'Entrecasteaux, la recherche de La Pérouse, disparu, s'est soldé par un échec...", 'dentre-text-p2': "Les côtes est de la Terre de Van Diemen (Tasmanie)...", 'dentre-text-p3': "68 lieux furent nommés le long de ces côtes...", 'dentre-text-p4': "Ce ne fut pas une tâche facile pour le commandant...", 'dentre-text-p5': "Des officiers, comme Jurien...", 'dentre-text-p6': "Les lieux visités et nommés par l'expédition...",
    ...
    'en': {
        ...
        'detail-rb-p1': "The frigates reached Teneriffe on 23 October, and the Cape of Good Hope on 16 February 1792...",
        'detail-rb-p2': "The southeastern Tasmanian coast was first sighted on 20 April 1792...",
        'detail-rb-heading2': "The naming of the d’Entrecasteaux channel",
        'detail-rb-p3': "During their stay, the hydrographers and officers prepared...",
        'detail-rb-p4': "Along the shores of Van Diemen Land, the commander named...",
        'detail-rb-p5': "These three charts below show parts of the coasts...",
